...
class PengeluaranController extends Controller
{
    ...
    return datatables()
        ...
        ->addColumn('created_at', function ($pengeluaran){
            return tgl_ID($pengeluaran->created_at, false);
        })
        ...
        ->addColumn('aksi', function ($pengeluaran){
            return '<div class="btn-group">
                <button type="button" onclick="editForm(`'. route('pengeluaran.update', $pengeluaran->id_pengeluaran) .'`)" class="btn btn-xs btn-warning btn-flat"><i class="fa fa-edit"></i></button>
